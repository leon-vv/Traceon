...
backend_functions = {
    ...
    'trace_particle': (sz, times_block, tracing_block, dbl, bool, field_fun, bounds, dbl, vp),
    ...
    'trace_particle_radial': (sz, times_block, tracing_block, dbl, bool, bounds, dbl, dbl_p, EffectivePointCharges2D, EffectivePointCharges2D, EffectivePointCharges3D),
    'field_radial_derivs': (None, v3, v3, z_values, arr(ndim=3), sz),
    'trace_particle_radial_derivs': (sz, times_block, tracing_block, dbl, bool, bounds, dbl, z_values, radial_coeffs, radial_coeffs, sz),
    ...
    'trace_particle_3d': (sz, times_block, tracing_block, dbl, bool, bounds, dbl, EffectivePointCharges3D, EffectivePointCharges3D, dbl_p),
    'field_3d_derivs': (None, v3, v3, z_values, arr(ndim=5), sz),
    'trace_particle_3d_derivs': (sz, times_block, tracing_block, dbl, bool, bounds, dbl, z_values, arr(ndim=5), arr(ndim=5), sz),
