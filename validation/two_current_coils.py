...
class TwoCurrentCoils(Validation):
    ...
    def create_mesh(self, MSF, symmetry, higher_order):
        boundary = v.Path.line([0., 0., 50e-3], [100e-3, 0., 50e-3]).extend_with_line([100e-3, 0., -50e-3]).extend_with_line([0., 0., -50e-3])
        boundary.name = 'boundary'

        coil1 = v.Surface.disk_xz(10e-3, 5e-3, 1e-3) 
        coil2 = v.Surface.disk_xz(10e-3, -5e-3, 1e-3) 
        ...
        block  = v.Path.rectangle_xz(5e-3, 15e-3, -1e-3, 1e-3)
        block.name = 'block'
